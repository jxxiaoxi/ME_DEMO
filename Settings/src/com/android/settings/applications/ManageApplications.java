...
public class ManageApplications extends Fragment implements
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if( FeatureOption.HY_WHITE_THEME_SETTINGS ) {
            menu.add(0, SHOW_RUNNING_SERVICES, 3,  R.string.show_running_services)
                    .setIcon(R.drawable.ic_menu_apps_show_service_light)
                    .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
            menu.add(0, SHOW_BACKGROUND_PROCESSES, 3,  R.string.show_background_processes)
                    .setIcon(R.drawable.ic_menu_apps_show_cache_light)
                    .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
        } else { */
            menu.add(0, SHOW_RUNNING_SERVICES, 3,  R.string.show_running_services)
    ...
    public void onDestroy() {
        ...
        for(TabInfo tab : mTabs) {
            if (tab.mApplications != null && tab.mApplications.mSession != null) {
                tab.mApplications.mSession.release();
            }
        }
        /// @}
        super.onDestroy();
