    ...
    private int getBtClassDrawable() {
            ...
            switch (btClass.getMajorDeviceClass()) {
                case BluetoothClass.Device.Major.COMPUTER:
                    ...
                    if (FeatureOption.HY_WHITE_THEME_SETTINGS)
                        return R.drawable.ic_bt_laptop_light;
                    else
                        return R.drawable.ic_bt_laptop;

                case BluetoothClass.Device.Major.PHONE:
                    if (FeatureOption.HY_WHITE_THEME_SETTINGS)
                        return R.drawable.ic_bt_cellphone_light;
                    else 
                        return R.drawable.ic_bt_cellphone; // end 
        ...
        if (btClass != null) {
            if (btClass.doesClassMatch(BluetoothClass.PROFILE_A2DP)) {
                if(FeatureOption.HY_WHITE_THEME_SETTINGS) // added by sijingjing
                    return R.drawable.ic_bt_headphones_a2dp_light;
                return R.drawable.ic_bt_headphones_a2dp;

            }
            if (btClass.doesClassMatch(BluetoothClass.PROFILE_HEADSET)) {
                if(FeatureOption.HY_WHITE_THEME_SETTINGS) // added by sijingjing
                    return R.drawable.ic_bt_headset_hfp_light;
