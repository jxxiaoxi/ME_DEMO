...
public class ChooseLockPattern extends PreferenceActivity {
    ...
    public static class ChooseLockPatternFragment extends Fragment
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            // setupViews()
            // modified by sijingjing for white settings
            View view;
            if( FeatureOption.HY_WHITE_THEME_SETTINGS )
               view = inflater.inflate(R.layout.choose_lock_pattern_white, null);
            else view = inflater.inflate(R.layout.choose_lock_pattern, null);
            // end
