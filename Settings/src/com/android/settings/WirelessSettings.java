...
public class WirelessSettings extends RestrictedSettingsFragment 
    ...
    private boolean isSmsSupported() {
        ...
        /// M: Use TelephonyManager.isSmsCapable() instead of checking telephony phone type, for 3g_data_sms
        /// flavor project phone type is none, but it has sms feature
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mConnectivityManager != null) {
            if (isSecondaryUser || !mConnectivityManager.isTetheringSupported()) {
