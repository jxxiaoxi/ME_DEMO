...
public class WallpaperTypeSettings extends SettingsPreferenceFragment {
    ...
    private void populateWallpaperTypes() {
        ...
        for (ResolveInfo info : rList) {
            if ("com.jrdcom.launcher".equals(info.activityInfo.packageName) && "com.jrdcom.launcher.LockScreenWallpaperChooser".equals(info.activityInfo.name))
                    continue;
			if ("com.google.android.apps.photos.phone.SetWallpaperActivity"
					.equals(info.activityInfo.name)
					&& FeatureOption.CUSTOM_HAIER) {
				continue;
			}
