...
public class Settings extends PreferenceActivity
    ...
    int mHeadersCategory = R.xml.settings_headers_tab_style;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if (TAB_STYLE) {
			...
			if (this.getClass().equals(Settings.class)) {
				int index = getIntent().getIntExtra("tab_index",
						mCurrentTabIndex);
				setupTab();
				chooseTab(index);
			}
    ...
    public Intent onBuildStartFragmentIntent(String fragmentName, Bundle args,
        ...
        // added by sijingjing
        if ( ManageApplications.class.getName().equals(fragmentName) && FeatureOption.HY_WHITE_THEME_SETTINGS)
            intent.setClass(this, ManageApplicationsActivity.class);
        else if (InstalledAppDetails.class.getName().equals(fragmentName) && FeatureOption.HY_WHITE_THEME_SETTINGS)
            intent.setClass(this, InstalledAppDetailsTop.class);
        else  // end 
            ...
            /**@ }*/
              ...
              // M: add by ourself {@
               ...
               /// @}
                ...
                target.remove(i);
			} else if (id == R.id.device_safety) { // add by liuwei for Regulations and safety
				if (!FeatureOption.HY_SUPPORT_REGULATIONS) {
					target.remove(i);
				}
			}
    ...
    public static class DeviceSafety extends Settings { /* empty */ }
	//add by liuwei for tab style
