...
public class SimInfoEditor extends SettingsPreferenceFragment implements
	...
	getPreferenceScreen().removePreference(findPreference(KEY_SIM_COLOR));//add huangzs
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
            Preference preference) {
                               //add by ganyu start 	
			        if(mSimName instanceof EditTextPreference) 	
			        { 	
			               mSimName = (EditTextPreference) mSimName; 	
			        EditText ed = ((EditTextPreference) mSimName).getEditText(); 	
			        ...
			        if(mSimNumber instanceof EditTextPreference) 	
			        { 	
			               mSimNumber = (EditTextPreference) mSimNumber; 	
			        EditText ed = ((EditTextPreference) mSimNumber).getEditText(); 	
