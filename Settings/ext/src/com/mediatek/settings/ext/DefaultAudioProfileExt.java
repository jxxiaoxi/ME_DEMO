...
import com.mediatek.common.featureoption.FeatureOption;
 ...
 public class DefaultAudioProfileExt  extends ContextWrapper implements IAudioProfileExt {
    ...
    public DefaultAudioProfileExt(Context context) {
        super(context);
        // added by sijingjing for white settings
        if( FeatureOption.HY_WHITE_THEME_SETTINGS )
            getBaseContext().setTheme(android.R.style.Theme_Holo_Light);
    ...
    public void setRingtonePickerParams(Intent intent) {
        intent.putExtra(RingtoneManager.EXTRA_RINGTONE_SHOW_MORE_RINGTONES, true);//modify by ganyu
