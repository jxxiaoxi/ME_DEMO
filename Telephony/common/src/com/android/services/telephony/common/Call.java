...
public final class Call implements Parcelable {
    ...
    public Call(Call call) {
        ...
        mConnectTimeReal = call.mConnectTimeReal;
        /// @}
    }
    ...
    public boolean isConferenceCall() {
        ...
        return mChildCallIds.size() >= 2 || isVoLteConferenceCall();
        /// @}
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        // For ALPS01529355: The call timer will be affected when the system time changed @{
        // It's caused by using connection.getConnectTime() to calculate call time.
        // Solution is use connection.getDurationMillis to calculate time, which is based on
        // SystemClock.elapsedRealtime().
        dest.writeLong(mConnectTimeReal);
        /// @}
    }
    ...
    public String toString() {
        return Objects.toStringHelper(this)
                ...
                // Show real connection time.
                .add("mConnectTimeReal", mConnectTimeReal)
                /// @}
                .toString();
    }
    ...
    public boolean isECCCall() {
        return this.mIdentification.isECCCall();
    }

    public void markAsECCCall() {
        this.mIdentification.markAsECCCall();
    }
    /// @}
    ...
    public String getPAUField() {
        return this.mIdentification.getPAUField();
    }

    public void setPAUField(String pau) {
        this.mIdentification.setPAUField(pau);
    }
    /// @}
    ...
    public boolean isWaitingCall() {
        return this.mIdentification.isWaitingCall();
    }
    ...
    public void markAsWaitingCall(boolean isWaiting) {
        this.mIdentification.markAsWaitingCall(isWaiting);
    }
    /// @}

    /// for VoLTE Conference Call@{
    public static class IMSCallMode {
        public static final int IMS_VOICE_CALL = 20;
        public static final int IMS_VIDEO_CALL = 21;
        public static final int IMS_VOICE_CONF_HOST = 22;
        public static final int IMS_VOICE_CONF_PARTICIPANT = 23;
    }

    public int getIMSCallMode() {
        return this.mIdentification.getIMSCallMode();
    }

    public void setIMSCallMode(int callMode) {
        this.mIdentification.setIMSCallMode(callMode);
    }

    public boolean isVoLteConferenceCall() {
        return this.mIdentification.isVoLteConferenceCall();
    }

    public boolean isVoLteConferenceHost() {
        return this.mIdentification.isVoLteConferenceHost();
    }

    public void setConferenceId(int id) {
        this.mIdentification.setConferenceId(id);
    }

    public int getConferenceId() {
        return this.mIdentification.getConferenceId();
    }
    /// @}
     ...
     *  It's caused by using System.currentTimeMillis() to calculate call time.
     *  Solution is use SystemClock.elapsedRealtime() to calculate time.
     * @return the duration time between call start and now.
     */
    ...
    *  Solution is use SystemClock.elapsedRealtime() to calculate time.
    */
   public void setConnectTimeReal(long realTime) {
       mConnectTimeReal = realTime;
   }
}
