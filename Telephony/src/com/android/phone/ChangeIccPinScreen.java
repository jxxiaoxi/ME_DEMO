...
//                                            Message.obtain(mHandler, EVENT_PIN_CHANGED));
        ...
        if (ar.exception == null) {
            ...
            if (mState == EntryState.ES_PIN) {
                ...
                if (getRetryPuk2Count() == 0) {
                    ...
                    String textToast = ext.changeTextContainingSim(getString(R.string.sim_permanently_locked), mSimId);
    ...
    private void displayPUKAlert() {
        ...
        String msg = ExtensionManager.getPhoneMiscExt().changeTextContainingSim(getString(R.string.puk_requested), mSimId);
    ...
    private void showPinPanel() {
        ...
        /// M: CT replace SIM to SIM/UIM @{
        String text = ExtensionManager.getPhoneMiscExt().changeTextContainingSim(getString(id), mSimId);
        setTitle(text);
        /// @}
        mPinRetryLabel.setText(getRetryPin());
    ...
    private class ChangeIccPinScreenBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ((action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)
                ...
                ///M: add for hot swap
                GeminiUtils.handleSimHotSwap(ChangeIccPinScreen.this, mSimId);
                ///@}
                updateScreenPanel();
            }
        }
