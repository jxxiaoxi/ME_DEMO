...
public class ErrorDialogActivity extends Activity {
    ...
    private AlertDialog mGenericErrorDialog = null;
    private AlertDialog mMissingVoicemailDialog = null;
    private AlertDialog mDropVoiceCallDialog = null;
    ...
    private void showDropVoiceCallDialog(int resid) {
        ...
        mDropVoiceCallDialog = new AlertDialog.Builder(this).setMessage(msg)
                .setPositiveButton(R.string.ok, clickListener)
                .setNegativeButton(R.string.cancel, clickNegativeListener)
                .setOnCancelListener(cancelListener)
                .create();
        mDropVoiceCallDialog.show();
    }
    /// @}
    ...
    private CharSequence handlePowerOffCase(int resId, CharSequence defaultValue) {
        ...
        if (resId == R.string.incall_error_power_off) {
            if (null != PhoneGlobals.getInstance().phoneMgr) {
                ...
                if (!hasInsertSim) {
                    /// fix ALPS01539638, show sim error when radio off and
                    // without any SIM card inserted.
    ...
    protected void onPause() {
        ...
        super.onPause();
        // finish this activity when the dialog move to background 
        ...
        if (mDropVoiceCallDialog != null && mDropVoiceCallDialog.isShowing()) {
        	mDropVoiceCallDialog.dismiss();
        }
