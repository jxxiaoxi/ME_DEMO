 ...
 // intent action to bring up voice mail settings
    ...
    private void setScreenEnabled() {
        ...
        if (list.size() == 0) {
            ...
            getPreferenceScreen().setEnabled(!PhoneWrapper.isRadioOffBySlot(slotId, this));
        }
    }
