...
class CallStateMonitor extends Handler {
    ...
    public void unregisterForNotifications(){
        ...
        /// M: @{
        // unregister mtk messages
        unRegisterForPhoneStatesMTK();
        /// @}
    }
    ...
    public static final int VOLTE_CONFERENCE_CALL_INDICATION = 777;
    /// @}

    /// M: Change Feature  ALPS00811599 @{
    // Call not hangup when network is abnormal
    public static final int DISCONNECTING_INFO_TIMEOUT = 5000;  // msec
    public static final int PHONE_HANDLE_DISCONNECTING = 150;
    /// @}
    ...
    private void registerForPhoneStatesMTK() {
        ...
        if (FeatureOption.isMtkVolteSupport()) {
            CallManagerWrapper.registerForVoLteConferenceCallNotification(this,
                    VOLTE_CONFERENCE_CALL_INDICATION, null);
        }
        /// @}
    }

    private void unRegisterForPhoneStatesMTK() {
        /// M: for VoLTE Conference Call @{
        if (FeatureOption.isMtkVolteSupport()) {
            CallManagerWrapper.unregisterForVoLteConferenceCallNotification(this);
        }
        /// @}
    }
}
