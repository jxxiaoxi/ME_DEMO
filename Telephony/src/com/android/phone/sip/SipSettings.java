...
public class SipSettings extends PreferenceActivity {
    ...
    public void onResume() {
        super.onResume();
        PhoneLog.d(TAG, "onResume: finish update the list, callManager Idle = " + mCallManager.getState());
        ...
        /// M: ALPS01535675 @{
        /// sync mSipSharedPreferences status
        PhoneLog.d(TAG, "onResume(): " + mSipSharedPreferences.isReceivingCallsEnabled());
    ...
    /**
     * M: ALPS01583834. Two activities exist in different tasks.
     */
    @Override
