    ...
    */
    ...
    private BluetoothProfile.ServiceListener mBluetoothProfileServiceListener =
         ...
         public void onServiceConnected(int profile, BluetoothProfile proxy) {
             ...
             /// M: For ALPS01509847
             //  In that case PhoneApp is killed, when device has been connected
             //  with Bluetooth. We need init the mBluetoothHeadsetState here.
             //  For Bluetooth won't Send "BluetoothHeadset.ACTION_CONNECTION_STATE_CHANGED"
             //  message again. If that, we don't have chance to correct the state. @{
             if (VDBG) log("onServiceConnected isBluetoothAvailable() : " + isBluetoothAvailable());
             if (isBluetoothAvailable()) {
                 if (mBluetoothHeadsetState != BluetoothHeadset.STATE_CONNECTED) {
                     mBluetoothHeadsetState = BluetoothHeadset.STATE_CONNECTED;
                     if (VDBG) log("onServiceConnected isBluetoothAudioConnected() : "
