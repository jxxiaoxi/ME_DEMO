...
public class NetworkSetting extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        ExtensionManager.getNetworkSettingExt().initPreferenceActivity(this);
    }
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        case DIALOG_NETWORK_MENU_SELECT:
            AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setMessage(R.string.manual_select_dialog_msg)
            ...
            ExtensionManager.getNetworkSettingExt().customizeAlertDialog(id, builder);
            dialog = builder.create();
            break;

        // In Gemini project, if the data connection is open on SIM A,when user do manual search PLMN,
        // actually we would firstly turn off the SIMA's data connection,after the search action is done,
        // we will auto restore the data connection,this action is done by framework.
    ...
    private void displayNetworkSelectionFailed(Throwable ex) {
        ...
        if ((ex != null && ex instanceof CommandException) &&
            ...
            IPhoneMiscExt ext = ExtensionManager.getPhoneMiscExt();
            status = ext.changeTextContainingSim(getString(R.string.not_allowed), mSlotId);
        } else {
    ...
    private void newManuSelectFemetocellPreference(PreferenceScreen root) {
        if(FeatureOption.isMtkFemtoCellSupport() &&
    ...
    protected void onDestroy() {
        super.onDestroy();
        ExtensionManager.getNetworkSettingExt().deinitPreferenceActivity();
    }
}
