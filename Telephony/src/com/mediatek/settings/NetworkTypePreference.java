...
public class NetworkTypePreference extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    private void init() {
        m2GCheckBoxPreference = (CheckBoxPreference)findPreference(KEY_NETWORK_TYPE_2G);
        m3GCheckBoxPreference = (CheckBoxPreference)findPreference(KEY_NETWORK_TYPE_3G);
        m4GCheckBoxPreference = (CheckBoxPreference)findPreference(KEY_NETWORK_TYPE_4G);

        if (m2GCheckBoxPreference != null) {
            m2GCheckBoxPreference.setOnPreferenceChangeListener(this);
        }
        if (m3GCheckBoxPreference != null) {
            m3GCheckBoxPreference.setOnPreferenceChangeListener(this);
        }
        if (m4GCheckBoxPreference != null) {
            m4GCheckBoxPreference.setOnPreferenceChangeListener(this);
        }
