...
public class VTAdvancedSettingEx extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        m3GSimList = GeminiUtils.get3GSimCards(PhoneGlobals.getInstance().getApplicationContext());
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mButtonVTReplace) {
            ...
            intent.putExtra(MultipleSimActivity.INTENT_KEY, "ListPreference");
                ...
                || preference == mButtonVTPeerBigger
                || preference == mButtonVTMoVideo
                || preference == mButtonVTEnablePeerReplace
                || preference == mButtonVTAutoDropBack){
