...
public class NetworkEditor extends PreferenceActivity
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (menu != null) {
            ...
            if (getIntent().getBooleanExtra(PLMN_ADD, true)) {
                ...
                boolean isSame = mInitNetworkId == null || mInitNetworkId.equals(mNetworkId.getSummary())
     ...
     */
    public static int covertRilNW2Ap(int rilNW, int slotId) {
        int result = INDEX_2G;
        boolean is2GEnable = (rilNW & NetworkEditor.RIL_2G) != 0;
        boolean is3GEnable = (rilNW & NetworkEditor.RIL_3G) != 0;
        boolean is4GEnable = GeminiUtils.is4GSimSlot(slotId) && ((rilNW & NetworkEditor.RIL_4G) != 0);
    ...
    private void updateNetWorkInfo(Intent intent) {
        ...
        if(TextUtils.isEmpty(mNetworkInfo.getNetWorkMode())) {
            ...
            act = covertRilNW2Ap(act, mSlotId);
    ...
    private void updateNetworkType(Intent intent) {
        int act = intent.getIntExtra(PLMN_SERVICE, 0);
        int index = covertRilNW2Ap(act, mSlotId);
