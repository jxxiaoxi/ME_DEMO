...
public class PLMNListPreference extends TimeConsumingPreferenceActivity {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        PhoneLog.d(LOG_TAG, "onPreferenceTreeClick()... preference: " + preference
        ...
        NetworkInfoWithAcT info = mPreferenceMap.get(preference);
        /// M: ALPS00541579
        if (null == info) {
            return false;
        }
    ...
    public void onResume() {
        ...
        PhoneLog.d(LOG_TAG, "onResume()... mListItemClicked: " + mListItemClicked);
    ...
    private String getNWString(int rilNW) {
        int index = NetworkEditor.covertRilNW2Ap(rilNW, mSlotId);
        String summary = "";
    ...
    private void setScreenEnabled() {
        ...
        PhoneLog.d(LOG_TAG, "setScreenEnabled()... + mListItemClicked: " + mListItemClicked);
    ...
    protected void onStop() {
        super.onStop();
        PhoneLog.d(LOG_TAG, "onStop()... mListItemClicked: " + mListItemClicked);
        mListItemClicked = false;
        setScreenEnabled();
    }
}
