...
public class SelectSimCardActivity extends PreferenceActivity
    ...
    public void onCreate(Bundle bundle) {
        ...
        mSimPrefMainScreen = getPreferenceManager().createPreferenceScreen(this);
    ...
    private void initPreferenceScreen() {
        ...
        if (mSimInfoList.size() != mSimPrefMainScreen.getPreferenceCount()) {
            ...
            for (SimInfoRecord siminfo: mSimInfoList) {
                ...
                SimCardInfoPreference infoPref = null;
                infoPref = new SimCardInfoPreference(mType, this);
    ...
    public int getNetworkMode(int buttonNetworkMode, int slotId) {
        ...
        log("getNetworkMode slot = " + slotId + " settingsNetworkMode = " + modemNetworkMode);
        ...
        log("getNetworkMode change slot = " + slotId + " modemNetworkMode = " + modemNetworkMode);
