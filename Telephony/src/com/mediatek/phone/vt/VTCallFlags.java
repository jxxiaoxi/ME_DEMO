...
public final class VTCallFlags {

    public boolean mVTIsMT;     // indicate the VT Call is MO or MT.
    // should be set before calling VTManagerWrapper.setVTOpen() and VTSettingUtils.pushVTSettingParams
    public boolean mVTShouldCloseVTManager;
    public VTConnectionStarttime mVTConnectionStarttime;

    private static VTCallFlags sInstance = new VTCallFlags();

    /**
     * Get the VTCallFlags instance
     * @return    VTCallFlags instance
     */
    public static VTCallFlags getInstance() {
        return sInstance;
    }
