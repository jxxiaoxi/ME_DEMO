...
public class PhoneRecorder extends Recorder {
    ...
    private void stopTimer() {
		...
		mTask = null;
		mTimeSec = 0;
		Settings.System.putString(mContext.getApplicationContext().getContentResolver(), "PHONE_VOICE_RECORDING_TIME", "");
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case PHONE_VOICE_RECORDING:
                	int ms = mTimeSec * 1000;
        			SimpleDateFormat formatr = new SimpleDateFormat("mm:ss");
        			String hms = formatr.format(ms);
        			Settings.System.putString(mContext.getApplicationContext().getContentResolver(), "PHONE_VOICE_RECORDING_TIME", hms);
        			mTimeSec ++;
                	break;
                default:
                    break;
