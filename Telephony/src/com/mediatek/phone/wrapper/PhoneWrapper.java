...
public class PhoneWrapper {
    ...
    public static final String EXTRA_SIM_SWITCH_LOCKED = TelephonyIntents.EXTRA_SIM_SWITCH_LOCKED;
    public static final String EXTRA_CAPABILITY_SIM = TelephonyIntents.EXTRA_CAPABILITY_SIM;
    public static final String EXTRA_CAPABILITY = TelephonyIntents.EXTRA_CAPABILITY;
    public static final String EVENT_CAPABILITY_SWITCH_START_MD_RESET =
            TelephonyIntents.EVENT_CAPABILITY_SWITCH_START_MD_RESET;
    public static final String EVENT_CAPABILITY_SWITCH_DONE =
            TelephonyIntents.EVENT_CAPABILITY_SWITCH_DONE;
    public static final String EVENT_PRE_CAPABILITY_SWITCH =
            TelephonyIntents.EVENT_PRE_CAPABILITY_SWITCH;
    public static final String EVENT_SIM_SWITCH_LOCK_CHANGED =
            TelephonyIntents.EVENT_SIM_SWITCH_LOCK_CHANGED;
