...
public class CallPickerAdapter extends BaseAdapter {
    ...
    private int[] mSimDarkBorderMap = {
            R.drawable.mtk_sim_dark_blue,
            R.drawable.mtk_sim_dark_orange,
            R.drawable.mtk_sim_dark_green,
            R.drawable.mtk_sim_dark_purple,
        };
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.mtk_call_select_list_item, null);
        ...
        if (GeminiUtils.isGeminiSupport()) {
            ...
            if (PhoneConstants.PHONE_TYPE_SIP == phoneType) {
                if (null != operator && operator.getVisibility() == View.VISIBLE) {
                    operator.setBackgroundResource(R.drawable.mtk_sim_dark_internet_call);
                }
            } else {
            ...
            if (null != operator && operator.getVisibility() == View.VISIBLE) {
                operator.setBackgroundResource(R.drawable.mtk_sim_dark_purple);
            }
        }
        if (null != operator && operator.getVisibility() == View.VISIBLE) {
