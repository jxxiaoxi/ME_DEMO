...
public class CallCommandClient {
    ...
    public void addVoLteConfMember(int conferenceId, String number) {
        if (mCommandService == null) {
            Log.e(this, "Cannot addVoLteConfMember, CallCommandService == null");
            return;
        }

        try {
            Log.d(this, "addVoLteConfMember, conferenceId = "+ conferenceId + ", number =" +number);
            mCommandService.addVoLteConfMember(conferenceId, number);
        } catch (RemoteException e) {
            Log.d(this, "Error on addVoLteConfMember");
        }
    }
    /// @}
    ...
    { 
     Log.i(this, "inCallActivityShowDone()"); 
      if(mCommandService == null){ 
      Log.e(this, "Cannot inCallActivityShowDone; CallCommandService == null"); 
      return; 
     } 
     try{ 
      mCommandService.inCallActivityShowDone(); 
     }catch(RemoteException e){ 
      Log.e(this, "Error inCallActivityShowDone."); 
     } 
    }
}
