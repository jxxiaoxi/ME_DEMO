...
public class DialpadFragment extends BaseFragment<DialpadPresenter, DialpadPresenter.DialpadUi>
    ...
    public boolean onHover(View v, MotionEvent event) {
        ...
        /// M: For ALPS01593785, should not continue to execute if the activity is finished. @{
        if (getActivity() == null || getActivity().isFinishing()) {
            Log.d(this, "onHover, the activity is null or finishing ");
            return true;
        }
        /// @}
        final AccessibilityManager accessibilityManager = (AccessibilityManager)
    ...
    public boolean onTouch(View v, MotionEvent event) {
		...
		if (isPhoneLock) {
			mDiapadListener.onDiapadClickOrTouch();
		}
	...
	// add by liuwei for 5s srceen off
	OnDiapadListener mDiapadListener;
	// Supports phone lock feature
	private boolean isPhoneLock;

	public interface OnDiapadListener {
	...
	public void onAttach(Activity activity) {
		...
		mDiapadListener = (OnDiapadListener) activity;
	}
}
