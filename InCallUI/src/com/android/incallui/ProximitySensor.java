...
public class ProximitySensor implements AccelerometerListener.OrientationListener,
    ...
    private void setupForSmartBook(Context context) {
        if (FeatureOptionWrapper.isMtkSmartBookSupport()) {
            mContext = context;
    ...
    public boolean isSmartBookPlugged() {
        ...
        if (FeatureOptionWrapper.isMtkSmartBookSupport() && mDisplayManager != null) {
    ...
    public void screenOffForSmartBook() {
        if (FeatureOptionWrapper.isMtkSmartBookSupport() && isSmartBookPlugged()) {
    ...
    private class SmartBookBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (FeatureOptionWrapper.isMtkSmartBookSupport() && Intent.ACTION_SMARTBOOK_PLUG.equals(action)) {
                ...
                if (isSmartBookPlugged) {
                    // ScreenOff when plugging on Smart Book with inCallScreen
                    // in background.
