...
public class PostCharDialogFragment extends DialogFragment {
    ...
    private static final String POST_DIALER_STR = "post_dialer_str";
    ...
    public void setParameters(int callId, String postDialStr) {
        mCallId = callId;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mCallId = savedInstanceState.getInt(CALL_ID);
            mPostDialStr = savedInstanceState.getString(POST_DIALER_STR);
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(CALL_ID, mCallId);
        outState.putString(POST_DIALER_STR, mPostDialStr);
    }
