...
public class Workspace extends SmoothPagedView
    ...
    class WallpaperOffsetInterpolator implements Choreographer.FrameCallback {
        ...
        private void updateOffset(boolean force) {
            if (mWaitingForUpdate || force) {
                ...
                if (android.os.SystemProperties.getBoolean("ro.launcher.slide",true) && computeScrollOffset() && mWindowToken != null) {
                    try {
    ...
    public void showOutlinesTemporarily() {
        if(isSupportCycleSlidingScreen()) return;
...
*/
    ...
    Animator getChangeStateAnimation(final State state, boolean animated, int delay, int snapPage,
        ...
        float finalSearchBarAlpha = !stateIsNormal ? 0f : (Launcher.HIDE_SEARCH_BAR ? 0f : 1f);
