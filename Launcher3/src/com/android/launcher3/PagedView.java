...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    public void scrollLeft() {
        ...
        /// M: modify to cycle sliding screen.
        if (isSupportCycleSlidingScreen() && (mCurrentPage == 0) && (mNextPage == INVALID_PAGE)) {
            mIsCycleSlidingBound = true;
    ...
    public void scrollRight() {
        ...
        /// M: modify to cycle sliding screen.
        if (isSupportCycleSlidingScreen() && (mCurrentPage == getChildCount() - 1) && (mNextPage == INVALID_PAGE)) {
            mIsCycleSlidingBound = true;
            snapToPage(0);
        }
    }
    ...
    public void setIsCycleSlidingBound(boolean value) {
    	mIsCycleSlidingBound = value;
    }
}
